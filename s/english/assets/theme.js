/* ============================================================
   ...
   chosen theme in localStorage, and injects a sun/moon toggle
   button (inline SVG so the icon stays perfectly centred — text
   glyphs like ☀/☾ shift with font/emoji fallback metrics).
