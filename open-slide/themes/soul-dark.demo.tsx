...
const styles = `
  ...
  .sd-fadeUp { opacity: 0; animation: sd-fadeUp 0.8s cubic-bezier(.2,.7,.2,1) forwards; }
`;
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>SOUL-DARK · THEME</Eyebrow>
      <Tag text="v1" />
    </div>
    <div>
      <Title>Soul Dark</Title>
      <p
        className="sd-fadeUp"
        style={{
          marginTop: 36,
      ...
      >
        Editorial dark with a <span style={{ color: 'var(--osd-accent)' }}>warm amber</span> soul.
      </p>
    </div>
    <Footer />
  </div>
...
const Content: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#5eb3a8">CHAPTER · BODY TYPE</Eyebrow>
    <h2
      className="sd-fadeUp"
      style={{
        margin: '4px 0 0',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginTop: 16 }}>
      <Bullet text="Hairline-bordered cards on a faint masked grid" />
      <Bullet text="Mono labels carry the identity" />
      <Bullet text="Amber is the single accent — hold the line" />
    </div>
    <Footer />
  </div>
);
