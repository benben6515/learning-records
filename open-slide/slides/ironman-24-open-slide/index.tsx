...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>IRONMAN 2026 · DAY 24</Eyebrow>
      <Tag text="24 / 30" />
    </div>
    <div>
      <Title accent>24-open-slide</Title>
      <p
        className="oc-fadeUp"
        style={{
          margin: '36px 0 0',
...
const CoreConcepts: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#6fc7ec">CORE CONCEPTS</Eyebrow>
    <H2>核心概念</H2>
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 44 }}>
      <Punch>
        React-first：每頁是一個 <span style={{ color: 'var(--osd-accent)' }}>React component</span>
      </Punch>
      <p
        className="oc-fadeUp"
        style={{
      ...
      >
        畫布固定 <Mono>1920×1080</Mono>——沒有排版引擎可對抗
      </p>
      <p
        className="oc-fadeUp"
        style={{
...
const CollabFlow: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#e070c8">HUMAN × AGENT</Eyebrow>
    <H2>人機協作流程</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        <Mono>npx @open-slide/cli init</Mono> 起 workspace
      </FlowRow>
      <FlowRow n={2}>
        <Mono>/create-slide</Mono>：agent 直接寫出整份 deck
      </FlowRow>
      <FlowRow n={3}>Inspect：點畫面上的元素，改字體色彩即存</FlowRow>
      <FlowRow n={4}>
        Comment ＋ <Mono>/apply-comments</Mono>：點哪、說什麼、就改哪
      </FlowRow>
    </div>
    <Footer />
  </div>
...
// ─── Page 4: 簡報 = code = 好處免費送 ────────────────────────────────────────
const CodeBenefits: Page = () => (
  <div
    style={{
      ...fill,
      padding: '100px 120px',
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#52d6a0">SLIDES AS CODE</Eyebrow>
    <H2>簡報 = code = 好處免費送</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>Deck 進 git：版本控管、diff、多人協作</FlowRow>
      <FlowRow n={2}>Agent 無關：Claude Code、Codex、Cursor、OpenCode 都能駕駛</FlowRow>
    </div>
    <Footer />
  </div>
);
...
const Takeaways: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow>TAKEAWAYS · DAY 24</Eyebrow>
    <H2>今天帶走三件事</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <Takeaway n={1}>
        與其讓 AI 操作簡報軟體，不如讓簡報<span style={{ color: 'var(--osd-accent)' }}>
          變成 code
        </span>
      </Takeaway>
      <Takeaway n={2}>改第十版也不心痛，因為 git 記著每一版</Takeaway>
      <Takeaway n={3}>明天：Matt Pocock skills（上）</Takeaway>
    </div>
    <div style={{ flex: 1 }} />
...
export const meta: SlideMeta = {
  title: '24-open-slide｜為 agent 而生的簡報框架 — Day 24',
  createdAt: '2026-09-01T16:16:23.623Z',
  theme: 'opencode',
};

export default [Cover, CoreConcepts, CollabFlow, CodeBenefits, Takeaways] satisfies Page[];
