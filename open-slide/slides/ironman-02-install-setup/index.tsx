...
const CodeCard = ({
  ...
  >
    ...
    {desc && <div style={{ fontSize: 26, lineHeight: 1.5, color: bodySoft }}>{desc}</div>}
  </div>
);
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>IRONMAN 2026 · DAY 02</Eyebrow>
      <Tag text="02 / 30" />
    </div>
    <div>
      <Title accent>02-opencode</Title>
      <p
        className="oc-fadeUp"
        style={{
          margin: '36px 0 0',
...
const Install: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color={codeGreen}>INSTALL</Eyebrow>
    <H2>安裝的三條路</H2>
...
const Provider: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#9d7cd8">PROVIDER</Eyebrow>
    <H2>Provider 連線</H2>
    <div style={{ display: 'flex', gap: 40, marginTop: 56 }}>
      <CodeCard
        tag="/connect"
        ...
        name="新手推薦"
        code="/connect"
        desc="opencode.ai/auth 拿 key，最快上手"
      />
      <CodeCard
        tag="bring your own"
        tagColor="#9d7cd8"
        ...
        desc="Anthropic / OpenAI / Google / 地端模型"
      />
      <CodeCard
        tag="no lock-in"
        name="不綁定"
        code="# your choice"
        desc="provider 是你的選擇權，不受任何一家約束"
      />
    </div>
    <Footer />
  </div>
...
const FirstRun: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#56b6c2">FIRST RUN</Eyebrow>
    <H2>第一次啟動</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        <Mono>cd</Mono> 進專案，然後下 <Mono>opencode</Mono>
      </FlowRow>
      <FlowRow n={2}>
        環境需求：現代 terminal
        <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
          <Tag text="Ghostty" color="#56b6c2" />
          <Tag text="WezTerm" color="#56b6c2" />
          <Tag text="Alacritty" color="#56b6c2" />
          <Tag text="Kitty" color="#56b6c2" />
        </div>
      </FlowRow>
      <FlowRow n={3}>
        驗收：問它「<span style={{ color: 'var(--osd-accent)' }}>這個專案在做什麼？</span>」
      </FlowRow>
    </div>
    <Footer />
  </div>
...
const Takeaways: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow>TAKEAWAYS · DAY 02</Eyebrow>
    <H2>今天帶走三件事</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <Takeaway n={1}>
        安裝一條路 <Mono>script</Mono>、維護一條路套件管理器
      </Takeaway>
      <Takeaway n={2}>
        provider 是<span style={{ color: 'var(--osd-accent)' }}>選擇權</span>
      </Takeaway>
      <Takeaway n={3}>明天：TUI 介面導覽</Takeaway>
    </div>
    <div style={{ flex: 1 }} />
...
export const meta: SlideMeta = {
  title: '02-opencode｜五分鐘安裝設定開工 — Day 02',
  createdAt: '2026-09-01T16:08:52.997Z',
  theme: 'opencode',
};

export default [Cover, Install, Provider, FirstRun, Takeaways] satisfies Page[];
