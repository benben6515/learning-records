...
const QuoteCard = ({
  ...
  >
    ...
    <div style={{ fontSize: 26, lineHeight: 1.5, color: bodySoft }}>{note}</div>
  </div>
);
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>IRONMAN 2026 · DAY 06</Eyebrow>
      <Tag text="06 / 30" />
    </div>
    <div>
      <Title accent>06-opencode</Title>
      <p
        className="oc-fadeUp"
        style={{
          margin: '36px 0 0',
...
const AtReference: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#56b6c2">@ REFERENCE</Eyebrow>
    <H2>
      <Mono>@</Mono> 引用活用
    </H2>
    <div style={{ display: 'flex', gap: 40, marginTop: 56 }}>
      <Card tag="precise" tagColor="#7fd88f" name="精準餵檔案" desc="fuzzy search 指到哪、讀到哪" highlight />
      <Card
        tag="reference"
        tagColor="#56b6c2"
        name="給範例"
        desc="「看 notes 怎麼做，在 settings 做一樣的」"
      />
      <Card
        tag="careful"
        tagColor="#f5a742"
        name="別整包丟"
        desc="@ 整個資料夾 ＝ context 變肥失準"
      />
    </div>
    <Footer />
  </div>
...
const ImageDrop: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#9d7cd8">IMAGE DROP</Eyebrow>
    <H2>圖片拖放</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        drag &amp; drop 直接進 <Mono>terminal</Mono>
      </FlowRow>
      <FlowRow n={2}>場景 1：UI 截圖當實作參考</FlowRow>
      <FlowRow n={3}>場景 2：error 截圖直接問</FlowRow>
    </div>
    <Footer />
  </div>
);
...
const JuniorMindset: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#7fd88f">MENTOR MINDSET</Eyebrow>
    <H2>帶 junior 心法</H2>
    <div style={{ display: 'flex', gap: 40, marginTop: 56 }}>
      <Card tag="detail" name="給細節" desc="目標、範圍、限制" highlight />
      <Card tag="example" tagColor="#56b6c2" name="給範例" desc="既有 code 當 reference" />
      <Card tag="stages" tagColor="#9d7cd8" name="分階段" desc="先 plan 再 build" />
    </div>
    <Footer />
  </div>
);
...
const BadVsGood: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#e06c75">PROMPT QUALITY</Eyebrow>
    <H2>反例 vs 正例</H2>
    <div style={{ display: 'flex', gap: 40, marginTop: 56 }}>
      <QuoteCard
        kind="反例"
        color="#e06c75"
        quote="幫我修 bug"
        note="AI 只能瞎猜：哪個 bug？在哪裡？怎麼修？"
      />
      <QuoteCard
        kind="正例"
        color="#7fd88f"
        quote="這 function 在 null input 會炸，加防禦並補測試"
        note="目標、範圍、做法一次給足"
      />
    </div>
    <div style={{ flex: 1 }} />
    <Punch>
      差距：細節量 = <span style={{ color: 'var(--osd-accent)' }}>AI 的命中率</span>
    </Punch>
    <Footer />
  </div>
);
...
const Takeaways: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow>TAKEAWAYS · DAY 06</Eyebrow>
    <H2>今天帶走三件事</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <Takeaway n={1}>
        上下文三寶：<Mono>@</Mono> 檔案、圖片、清楚目標
      </Takeaway>
      <Takeaway n={2}>
        你的細節品質 = <span style={{ color: 'var(--osd-accent)' }}>AI 產出品質</span>
      </Takeaway>
      <Takeaway n={3}>明天：/undo 與 /redo 安全網</Takeaway>
    </div>
    <div style={{ flex: 1 }} />
...
export const meta: SlideMeta = {
  title: '06-opencode｜上下文提供技巧 — Day 06',
  createdAt: '2026-09-01T16:16:05.623Z',
  theme: 'opencode',
};

export default [Cover, AtReference, ImageDrop, JuniorMindset, BadVsGood, Takeaways] satisfies Page[];
