...
const CompareCard = ({
  ...
  <div
    ...
    style={{
      ...
      padding: 36,
      background: surface,
      border: `1px solid ${tone === 'good' ? codePeach : '#9aa8f0'}60`,
      borderRadius: 'var(--osd-radius)',
    }}
  >
    <Tag text={head} color={tone === 'good' ? codePeach : '#9aa8f0'} />
...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>IRONMAN 2026 · DAY 22</Eyebrow>
      <Tag text="22 / 30" />
    </div>
    <div>
      <Title accent>22-pi</Title>
      <p
        className="oc-fadeUp"
        style={{
          margin: '36px 0 0',
...
const WhatIsPi: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#6fc7ec">WHAT IS PI</Eyebrow>
    <H2>pi 是什麼</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        Mario Zechner（badlogic）發起的 minimal agent harness（<span style={{ color: '#52d6a0' }}>MIT</span>）
      </FlowRow>
      <FlowRow n={2}>
        哲學：<span style={{ color: 'var(--osd-accent)' }}>鞍座合你的身形</span>，不是叫你改騎姿
      </FlowRow>
      <FlowRow n={3}>
        15+ providers；<Mono>/model</Mono> 或 Ctrl+L 隨時換、Ctrl+P 循環愛用清單
      </FlowRow>
    </div>
    <Footer />
  </div>
...
const Signature: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#e070c8">SIGNATURE</Eyebrow>
    <H2>招牌體驗</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        Session 是一棵樹：<Mono>/tree</Mono> 跳回分岔點、<Mono>/share</Mono> 丟 gist 拿連結
      </FlowRow>
      <FlowRow n={2}>
        Steering：Enter 插話 / Alt+Enter 排隊
      </FlowRow>
      <FlowRow n={3}>
        <Mono>AGENTS.md</Mono>（<Mono>~/.pi/agent/</Mono>）＋ <Mono>SYSTEM.md</Mono>（替換系統提示）
      </FlowRow>
    </div>
    <Footer />
  </div>
...
// ─── Page 4: Primitives, not features ────────────────────────────────────────
const Primitives: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#52d6a0">PRIMITIVES, NOT FEATURES</Eyebrow>
    ...
    >
      <FlowRow n={1}>
        刻意不內建：MCP、sub-agents、plan mode、permission popups
      </FlowRow>
      <FlowRow n={2}>
        全部可以用 extension 長——官方範例都有，甚至 <span style={{ color: codePeach }}>DOOM</span>
      </FlowRow>
      <FlowRow n={3}>
        更狂：叫 pi 自己寫，<Mono>/reload</Mono> 生效
      </FlowRow>
      <FlowRow n={4}>
        分享靠 packages：<Mono>pi install npm:... / git:...</Mono>
      </FlowRow>
    </div>
    <Footer />
  </div>
...
const PiVsOc: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#9aa8f0">PI VS OPENCODE</Eyebrow>
    <H2>pi vs opencode</H2>
    <div style={{ display: 'flex', gap: 40, marginTop: 48 }}>
      <CompareCard head="opencode" tone="bad">
        全配平台——擴充點應有盡有
      </CompareCard>
      <CompareCard head="pi" tone="good">
        可塑鞍座——<span style={{ color: codePeach }}>樹狀 session</span>、極簡核心
      </CompareCard>
    </div>
    <p
      className="oc-fadeUp"
    ...
    >
      相似：開源、terminal-first、多 provider——光譜兩端，互補不互斥
    </p>
    <Footer />
  </div>
);
...
const Takeaways: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow>TAKEAWAYS · DAY 22</Eyebrow>
    <H2>今天帶走三件事</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <Takeaway n={1}>
        功能可以升級，<span style={{ color: 'var(--osd-accent)' }}>核心複雜度</span>
        砍不掉——極簡是選擇
      </Takeaway>
      <Takeaway n={2}>Primitives, not features：缺的用 extension 長</Takeaway>
      <Takeaway n={3}>明天：OpenSpec</Takeaway>
    </div>
    <div style={{ flex: 1 }} />
...
export const meta: SlideMeta = {
  title: '22-pi｜極簡 agent harness 的魅力 — Day 22',
  createdAt: '2026-09-01T16:16:21.623Z',
  theme: 'opencode',
};

export default [Cover, WhatIsPi, Signature, Primitives, PiVsOc, Takeaways] satisfies Page[];
