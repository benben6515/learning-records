...
const Cover: Page = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Eyebrow>IRONMAN 2026 · DAY 19</Eyebrow>
      <Tag text="19 / 30" />
    </div>
    <div>
      <Title accent>19-opencode</Title>
      <p
        className="oc-fadeUp"
        style={{
          margin: '36px 0 0',
...
const MoveIn: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#4ec9b0">AI IN YOUR REPO</Eyebrow>
    <H2>AI 住進 repo</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        你在 issue / PR 留言，AI 在<span style={{ color: 'var(--osd-accent)' }}>你自己的 runner</span>
        上開工
      </FlowRow>
      <FlowRow n={2}>
        安裝：<Mono>opencode github install</Mono>（App ＋ workflow ＋ secrets 一次搞定）
      </FlowRow>
      <FlowRow n={3}>code 不落地第三方機器</FlowRow>
    </div>
    <Footer />
  </div>
);
...
const Triggers: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#ec6a9c">TRIGGERS</Eyebrow>
    <H2>GitHub 觸發方式</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        Comment 觸發：<Mono>/opencode</Mono> 或 <Mono>/oc</Mono>（不是 @！）
      </FlowRow>
      <FlowRow n={2}>
        玩法：<Mono>explain this issue</Mono>、<Mono>fix this</Mono>（建 branch 開 PR）
      </FlowRow>
      <FlowRow n={3}>PR Files tab 逐行留言：AI 自動收到檔案、行號、diff 前後文</FlowRow>
      <FlowRow n={4}>
        事件驅動：<Mono>issues</Mono> / <Mono>pull_request</Mono>（自動 review）/
        <Mono>schedule</Mono> / 手動
      </FlowRow>
    </div>
    <Footer />
  </div>
...
const GitLabBoundary: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow color="#a9b6c2">GITLAB & BOUNDARY</Eyebrow>
    <H2>GitLab 與人機邊界</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <FlowRow n={1}>
        GitLab 兩條路：Duo 的 <Mono>@opencode</Mono> mention；社群 CI component
      </FlowRow>
      <FlowRow n={2}>
        注意 <Mono>share</Mono> 設定：公開 repo 預設自動分享 session
      </FlowRow>
    </div>
    <div style={{ flex: 1 }} />
    <div style={{ display: 'flex', gap: 36, marginBottom: 24 }}>
      <Card
        tag="人機邊界"
        name="merge 在人手上"
        desc="AI 開 branch ＋ PR——merge 按鈕永遠在人手上"
        highlight
      />
    </div>
    <Footer />
...
const Takeaways: Page = () => (
  ...
  >
    <Styles />
    <GridBg />
    <Eyebrow>TAKEAWAYS · DAY 19</Eyebrow>
    <H2>今天帶走三件事</H2>
    <div
      style={{
        display: 'flex',
    ...
    >
      <Takeaway n={1}>超積極的自動化實習生：產出快、final review 是人</Takeaway>
      <Takeaway n={2}>GitHub 用 /oc、GitLab 用 @opencode</Takeaway>
      <Takeaway n={3}>明天：多模型策略</Takeaway>
    </div>
    <div style={{ flex: 1 }} />
...
export const meta: SlideMeta = {
  title: '19-opencode｜GitHub 與 GitLab 整合 — Day 19',
  createdAt: '2026-09-01T16:16:18.623Z',
  theme: 'opencode',
};

export default [Cover, MoveIn, Triggers, GitLabBoundary, Takeaways] satisfies Page[];
